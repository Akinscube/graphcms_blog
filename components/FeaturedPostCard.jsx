...
const FeaturedPostCard = ({ post }) => {
  return (
    <div className="relative h-72">
      ...
      <div className=" absolute rounded-lg bg-center bg-gradient-to-b opacity-50 from-gray-400 via-gray-700 to-black h-72 w-full" />
      ...
      <div className="absolute flex h-full w-full flex-col items-center justify-center rounded-lg p-4">
        ...
        <p className="text-shadow mb-4 text-2xl font-semibold text-white text-center">
          {post.title}
        </p>
